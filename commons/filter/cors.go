...
func Cors() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Header("Access-Control-Allow-Headers", "Access-Control-Allow-Headers,Cookie, Content-Length,Origin,cache-control,X-Requested-With, Content-Type, Accept, Authorization,New-Authorization, Token,KssUUID, Timestamp, UserId, New-Token,New-Expires-At") // 我们自定义的header字段都需要在这里声明
