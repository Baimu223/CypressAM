...
func (api *XkVideoCategoryApi) CreateXkVideoCategory(c *gin.Context) {
	// 1: 第一件事情就准备数据的载体
...
func (api *XkVideoCategoryApi) UpdateXkVideoCategory(c *gin.Context) {
	// 1: 第一件事情就准备数据的载体
	var xkcategory video.XkVideoCategory
	err := c.ShouldBindJSON(&xkcategory)
	if err != nil {
...
func (api *XkVideoCategoryApi) UpdateXkVideoCategoryStatus(c *gin.Context) {
	// 1: 第一件事情就准备数据的载体
...
func (api *XkVideoCategoryApi) GetXkVideoCategory(c *gin.Context) {
	var xkcategory video.XkVideoCategory
	// 绑定参数
...
func (api *XkVideoCategoryApi) DeleteById(c *gin.Context) {
	// 绑定参数用来获取/:id这个方式
	id := c.Param("id")
	// 开始执行
...
func (api *XkVideoCategoryApi) GetXkVideoCategoryDetail(c *gin.Context) {
	// 绑定参数用来获取/:id这个方式
	id := c.Param("id")
	// 这个是用来获取?age=123
	//age := c.Query("age")
...
func (api *XkVideoCategoryApi) LoadXkVideoCategoryPage(c *gin.Context) {
	// 创建一个分页对象
...
// 查询视频分类信息
func (api *XkVideoCategoryApi) FindCategories(c *gin.Context) {
...
// 查询所有的主分类信息
func (api *XkVideoCategoryApi) FindCategoryAll(c *gin.Context) {
...
// http://localhost:8888/bbs/delete/:id
func (api *XkVideoCategoryApi) DeleteByVideoCategoryId(c *gin.Context) {
	// 绑定参数用来获取/:id这个方式
	id := c.Param("id")
	// 开始执行
	parseUint, _ := strconv.ParseUint(id, 10, 64)
...
func (api *XkVideoCategoryApi) DeleteByVideoCategoryIds(c *gin.Context) {
	// 绑定参数用来获取/:id这个方式
	ids := c.Query("ids")
	// 开始执行
