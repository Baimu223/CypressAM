...
// 保存视频
func (api *XkVideoApi) SaveVideo(c *gin.Context) {
...
// 更新视频
func (api *XkVideoApi) UpdateVideo(c *gin.Context) {
...
// 查询分页
func (api *XkVideoApi) FindVideosPage(c *gin.Context) {
...
// 根据ID查询分类信息
func (api *XkVideoApi) GetVideosById(c *gin.Context) {
	// 绑定参数用来获取/:id这个方式
	id := c.Param("id")
